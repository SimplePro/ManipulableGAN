...
class Trainer:
    ...
    def train_epoch(self):
        ...
        return avg_triplet_loss, avg_perceptual_loss, avg_mse_loss, avg_gen_adversarial_loss, avg_disc_adversarial_loss
    ...
    def run(self, EPOCHS):
        ...
        for epoch in range(EPOCHS):
            ...
            train_tripletloss, train_per_loss, train_mse_loss, train_gen_adv_loss, train_disc_adv_loss = self.train_epoch()
            valid_tripletloss, valid_per_loss, valid_mse_loss, valid_gen_adv_loss, valid_disc_adv_loss = self.valid_epoch(epoch)

            print(f"TRAIN_LOSS\n(triplet: %.4f, perceptual: %.4f, mse: %.4f, gen-adv: %.4f, disc-adv: %.4f)\nVALID_LOSS\n(triplet: %.4f, perceptual: %.4f, mse: %.4f, gen-adv: %.4f, disc-adv: %.4f)\n" 
                  %(train_tripletloss, train_per_loss, train_mse_loss, train_gen_adv_loss, train_disc_adv_loss, valid_tripletloss, valid_per_loss, valid_mse_loss, valid_gen_adv_loss, valid_disc_adv_loss))
